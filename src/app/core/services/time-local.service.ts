...
@Injectable()
export class TimeLocalService implements TimeInterface {
  ...
  public tick() {
    this.timeModel.Sec++;
    if (this.timeModel.Sec > 59) {
      this.timeModel.Sec = 0;
      this.tickM();
    }
  ...
  private tickM() {
    this.timeModel.Mins++;
    if (this.timeModel.Mins > 59) {
      this.timeModel.Mins = 0;
      this.tickH();
    }
  }
  ...
  private tickH() {
    ...
    if (this.timeModel.Hours > 11) {
      this.timeModel.Hours = 0;
    }
  }
